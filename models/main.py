...
def main():
    ...
    config = {
        ...
        "N_stage2": 600,
        "patience": 50,
        "w_recon": 0.016190158616116182,
        "w_pred": 1.3472872421604274,
        "w_lin": 0.42863724503686995,
        "w_ms": 2.662021623160387,
        "w_kin": 0.02486780146680516,
        "w_psi": 0.02026531746859928,
        "std_x": stats["std_x"],
        "mu_x": stats["mu_x"],
        "std_u": stats["std_u"],
        "mu_u": stats["mu_u"],
